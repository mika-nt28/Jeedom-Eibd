...
function addCmdToTable(_cmd) {
	...
	tr.append($('<td>')
		 ...
		 .append($('<div>')
			.append($('<span>')
				.append($('<label class="checkbox-inline">')
					.append($('<input type="checkbox" class="cmdAttr checkbox-inline" data-size="mini" data-label-text="{{Ecriture}}" data-l1key="configuration" data-l2key="FlagWrite" checked/>'))
					.append('{{Ecriture}}')
					.append($('<sup>')
						.append($('<i class="fas fa-question-circle tooltips">')
		...
		.append($('<div>')
			.append($('<span>')
				.append($('<label class="checkbox-inline">')
					.append($('<input type="checkbox" class="cmdAttr checkbox-inline" data-size="mini" data-label-text="{{Mise-à-jour}}" data-l1key="configuration" data-l2key="FlagUpdate" checked/>'))
					.append('{{Mise-à-jour}}')
					.append($('<sup>')
						.append($('<i class="fas fa-question-circle tooltips">')
